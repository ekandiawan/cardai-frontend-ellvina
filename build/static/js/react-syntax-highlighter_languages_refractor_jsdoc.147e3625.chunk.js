                  ...
                  !(function (a, n) {
                    ...
                    if (s) {
                      ...
                      if (!r) {
                        ...
                        r = (s = e.languages.insertBefore(a, "comment", i))[t];
                      }
                      if (
                        (r instanceof RegExp && (r = s[t] = { pattern: r }),
                        Array.isArray(r))
                      )
                        for (var o = 0, p = r.length; o < p; o++)
                          r[o] instanceof RegExp && (r[o] = { pattern: r[o] }),
                            n(r[o]);
                      else n(r);
                    }
                  })(a, function (e) {
...
//# sourceMappingURL=react-syntax-highlighter_languages_refractor_jsdoc.147e3625.chunk.js.map
