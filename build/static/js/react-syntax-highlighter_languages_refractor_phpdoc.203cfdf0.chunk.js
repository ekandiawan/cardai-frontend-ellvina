...
(self.webpackChunkreact_scripts = self.webpackChunkreact_scripts || []).push([
  [4884, 902, 3047, 2227],
  {
                  ...
                  !(function (a, t) {
                    ...
                    if (i) {
                      ...
                      if (!s) {
                        ...
                        s = (i = e.languages.insertBefore(a, "comment", r))[n];
                      }
                      if (
                        (s instanceof RegExp && (s = i[n] = { pattern: s }),
                        Array.isArray(s))
                      )
                        for (var o = 0, l = s.length; o < l; o++)
                          s[o] instanceof RegExp && (s[o] = { pattern: s[o] }),
                            t(s[o]);
                      else t(s);
                    }
                  })(a, function (e) {
            ...
            tokenizePlaceholders: {
              value: function (t, n) {
                if (t.language === n && t.tokenStack) {
                  ...
                  !(function r(o) {
                    for (var l = 0; l < o.length && !(i >= s.length); l++) {
                      var p = o[l];
                      if (
                        "string" === typeof p ||
                        ...
                        if (g > -1) {
                          ...
                          var f = u.substring(0, g),
                            ...
                            h = [];
                          f && h.push.apply(h, r([f])),
                            h.push(y),
                            m && h.push.apply(h, r([m])),
                            "string" === typeof p
                              ? o.splice.apply(o, [l, 1].concat(h))
                              : (p.content = h);
                        }
    ...
    9220: function (e, a, t) {
      ...
      (e.exports = s), (s.displayName = "phpdoc"), (s.aliases = []);
    },
  },
]);
//# sourceMappingURL=react-syntax-highlighter_languages_refractor_phpdoc.203cfdf0.chunk.js.map
