                  ...
                  !(function (a, n) {
                    ...
                    if (s) {
                      ...
                      if (!i) {
                        ...
                        i = (s = e.languages.insertBefore(a, "comment", o))[t];
                      }
                      if (
                        (i instanceof RegExp && (i = s[t] = { pattern: i }),
                        Array.isArray(i))
                      )
                        for (var r = 0, c = i.length; r < c; r++)
                          i[r] instanceof RegExp && (i[r] = { pattern: i[r] }),
                            n(i[r]);
                      else n(i);
                    }
                  })(a, function (e) {
...
//# sourceMappingURL=react-syntax-highlighter_languages_refractor_javadoc.98c640d9.chunk.js.map
