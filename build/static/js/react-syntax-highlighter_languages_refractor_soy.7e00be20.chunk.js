            ...
            tokenizePlaceholders: {
              value: function (a, n) {
                if (a.language === n && a.tokenStack) {
                  ...
                  !(function i(o) {
                    for (var s = 0; s < o.length && !(r >= l.length); s++) {
                      var p = o[s];
                      if (
                        "string" === typeof p ||
                        ...
                        if (f > -1) {
                          ...
                          var m = g.substring(0, f),
                            ...
                            b = g.substring(f + d.length),
                            h = [];
                          m && h.push.apply(h, i([m])),
                            h.push(k),
...
//# sourceMappingURL=react-syntax-highlighter_languages_refractor_soy.7e00be20.chunk.js.map
