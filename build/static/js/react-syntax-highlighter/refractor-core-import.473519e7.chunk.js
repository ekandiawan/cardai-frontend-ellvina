/*! For license information please see refractor-core-import.473519e7.chunk.js.LICENSE.txt */
  ...
  [5082, 131, 5008, 7279, 2496],
  {
    ...
    3061: function (e, n, t) {
      ...
      e.exports = function (e, n) {
        var t,
          ...
          o = {};
        n || (n = {});
        for (l in g) (t = n[l]), (o[l] = null === t || void 0 === t ? g[l] : t);
        ...
        return (function (e, n) {
          ...
          (N = X()), (A = I ? ee : p), V--, Z++;
          for (; ++V < Z; )
            if ((10 === w && (G = W[K] || 1), 38 === (w = e.charCodeAt(V)))) {
              if (
              ...
              for (
                P = L = V + 1,
                  ...
                  $ = v[O],
                  T--;
                ++T < Z && $((F = e.charCodeAt(T)));

              )
                (g += c(F)), O === d && u.call(a, g) && ((t = g), (E = a[g]));
              (o = 59 === e.charCodeAt(T)) &&
                (T++, (l = O === d && s(g)) && ((t = g), (E = l))),
                (M = 1 + T - L),
                (o || _) &&
                ...
                k
                  ? (ne(),
                    ...
                    Y.push(k),
                    (j = X()).offset++,
                    R && R.call(U, k, { start: N, end: j }, e.slice(L - 1, T)),
                    (N = j))
                  : ((g = e.slice(L - 1, T)),
                    (J += g),
                    (G += g.length),
          ...
          function ee(e, n) {
            var t = X();
            (t.column += n), (t.offset += n), I.call(H, y[e], t, e);
          }
          function ne() {
            J &&
              (Y.push(J), z && z.call(B, J, { start: N, end: X() }), (J = ""));
          }
        })(e, o);
      };
    ...
    3835: function (e, n, t) {
      var a = (function (e) {
        var n = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
          ...
          r = {
            ...
            highlightElement: function (n, t, a) {
              ...
              if (
                (r.hooks.run("before-sanity-check", s),
          ...
          for (var g in t)
            if (t.hasOwnProperty(g) && t[g]) {
              ...
              for (var f = 0; f < d.length; ++f) {
                ...
                for (
                  var w = m.pattern || m, k = a.next, F = s;
                  k !== n.tail && !(p && F >= p.reach);
                  F += k.value.length, k = k.next
                ) {
                  var A = k.value;
                  ...
                  if (!(A instanceof l)) {
                    ...
                    if (y) {
                      ...
                      var E = S.index,
                        ...
                        L = F;
                      for (L += k.value.length; E >= L; )
                        L += (k = k.next).value.length;
                      if (((F = L -= k.value.length), k.value instanceof l))
                        continue;
                      for (
                        var O = k;
                        O !== n.tail && (L < P || "string" === typeof O.value);
                        O = O.next
                      )
                        C++, (L += O.value.length);
                    ...
                    var $ = S[0],
                      ...
                      j = A.slice(E + $.length),
                      M = F + A.length;
                    p && M > p.reach && (p.reach = M);
                    var T = k.prev;
                    if (
                      (N && ((T = u(n, T, N)), (F += N.length)),
                      c(n, T, C),
                      (k = u(n, T, new l(g, h ? r.tokenize($, h) : $, b, $))),
                      j && u(n, k, j),
                      C > 1)
                    ) {
                      var D = { cause: g + "," + f, reach: M };
                      i(e, n, t, k.prev, F, D),
        ...
        if (
          (p &&
            ((r.filename = p.src),
            p.hasAttribute("data-manual") && (r.manual = !0)),
          !r.manual)
        ) {
      ...
      e.exports && (e.exports = a),
        "undefined" !== typeof t.g && (t.g.Prism = a);
    },
    7172: function (e, n, t) {
      "use strict";
      var a = t(5317),
    ...
    4451: function (e, n, t) {
      ...
      function i(e, n, t, i) {
        var u,
          c = -1;
        for (s(this, "space", i), a.call(this, e, n); ++c < o; )
    ...
    6638: function (e, n, t) {
      ...
      (e.exports = f),
        ...
        (f.registered = function (e) {
          if ("string" !== typeof e)
            throw new Error(
              "Expected `string` for `language`, got `" + e + "`"
            );
          return g.call(f.languages, e);
        }),
        (f.listLanguages = function () {
          var e,
            n = f.languages,
            t = [];
          for (e in n) g.call(n, e) && "object" === typeof n[e] && t.push(e);
          return t;
        }),
        m(s),
        m(u),
        m(c),
        m(p),
        (f.util.encode = function (e) {
          return e;
        }),
        (f.Token.stringify = function (e, n, t) {
          var a;
          if ("string" === typeof e) return { type: "text", value: e };
          if ("Array" === f.util.type(e))
            return (function (e, n) {
              var t,
                a = [],
                r = e.length,
              ...
              (l = -1), (r = a.length);
              for (; ++l < r; ) (t = a[l]), (a[l] = f.Token.stringify(t, n, a));
              return a;
            })(e, n);
          (a = {
            type: e.type,
    ...
    6674: function (e, n, t) {
      ...
      e.exports = function (e, n, t) {
        ...
        return function (e, t) {
          ...
          (o.tagName = r && s.call(r, p) ? r[p] : p),
            t && u(t, o) && (i.unshift(t), (t = null));
          if (t) for (a in t) g(o.properties, a, t[a]);
          c(o.children, i),
            "template" === o.tagName &&
          ...
          null !== r &&
            ...
            "string" === typeof (u = r) &&
              (l.spaceSeparated
                ...
                : l.commaSeparated
                ? (u = i(u))
                : l.commaOrSpaceSeparated && (u = o(i(u).join(" ")))),
            "style" === s &&
              "string" !== typeof r &&
              (u = (function (e) {
                var n,
...
//# sourceMappingURL=refractor-core-import.473519e7.chunk.js.map
