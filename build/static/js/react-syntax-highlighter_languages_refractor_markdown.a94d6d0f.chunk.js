...
(self.webpackChunkreact_scripts = self.webpackChunkreact_scripts || []).push([
  [9835],
  {
    8446: function (n) {
          ...
          (n.languages.markdown = n.languages.extend("markup", {})),
            ...
            n.hooks.add("wrap", function (e) {
              if ("code-block" === e.type) {
                for (var t = "", a = 0, r = e.classes.length; a < r; a++) {
                  var i = e.classes[a],
                    u = /language-(.+)/.exec(i);
                  if (u) {
                    t = u[1];
      ...
      (n.exports = e), (e.displayName = "markdown"), (e.aliases = ["md"]);
    },
  },
]);
//# sourceMappingURL=react-syntax-highlighter_languages_refractor_markdown.a94d6d0f.chunk.js.map
